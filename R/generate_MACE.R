...
mace_scenario <- function() {
  ...
  OFATT2 <- OFATT |>
    filter(beta_mace_trt_before == 0,beta_mace_L==0,beta_disc_L==0,beta_wd_L==0) |>
...
#' @describeIn generate_mace Calculate sample size for logHRassumed
#'
#' @param Design design `data.frame` as generated by `mace_scenario`
#'
#' @returns for `mace_scenario_set_sample_size`: The Design data set with additional column sample_size
#' @export
mace_scenario_set_sample_size <- function(Design){
  within(Design, {
    # Compute sample size
