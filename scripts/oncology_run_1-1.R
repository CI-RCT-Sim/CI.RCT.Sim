...
#source("scripts/oncology_get_true_values.R")
#source("scripts/oncology_get_true_values_wo_censoring.R")
...
trueHR_with_censoring<-read.csv("scripts/trueHR_nsim40_n_ev10000withRandomCensTRUE.csv")
trueHR_without_censoring<-read.csv("scripts/trueHR_nsim40_n_ev10000withRandomCensFALSE.csv")


make_scen_table<-"scripts/oncology_make_scenario_table_1-3.R"
run_batches<-"scripts/oncology_batches_1-2.R"
