...
if(scen_select=="small_n") analysis_functions_list<-c(
    ...
    gformula = analyse_oncology_gformula(B = 20),
    gformula_uneq = analyse_oncology_gformula_unequal(B = 20)
    )
...
if(scen_select=="IPCW_extra") {
  ...
  analysis_functions_list<-list(
    ...
    gformula = analyse_oncology_gformula(B = 20),
    ipw = analyse_oncology_ipw(),
    rpsftm_IPCW =  analyse_oncology_mixed(method="RPSFTM",recensor = FALSE,B = 50,trunc_weights = 5,use_censoring_IPW = TRUE,requ_n_cens = 5),
    tse_IPCW =  analyse_oncology_mixed(method="TSE",recensor = FALSE,B = 50,trunc_weights = 5,use_censoring_IPW = TRUE,requ_n_cens = 5),
