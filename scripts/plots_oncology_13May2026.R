#Plots (I took it from CONFIRMS-CausalInf-Simulation-Study-Report/scripts/plots_onco.R on 13 May 2026)
#but then modified
...
results <- read_multiple(
  dir_ls("data", regexp = "results_onco_*"),
  check_design_names = FALSE
)

# install.packages("readxl")
tab <- readxl::read_xlsx("data/all_param_tab.xlsx")
